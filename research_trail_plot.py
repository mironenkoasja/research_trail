...
def run_all_functions(path_to_wos, treshold, title_of_pic):

    os.chdir(path_to_wos)

    txt_files = [txt for txt in os.listdir(os.getcwd()) if txt.endswith('.txt')]
...
run_all_functions(path_to_wos, treshold, title_of_pic)